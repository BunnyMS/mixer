...
function Mixer() { 
	...
	this.$interface = $('<div class="interface"><div class="interface-container"><img src="/images/'+this.bg+'" class="mixer-interface" /><img src="/images/web-mixer_spacer@2x.gif" class="mixer-spacer" /></div></div>');
	this.$media = $('<div class="media"><div class="media-container"><div class="media-title"><select class="title-select"></select><h5></h5></div><div class="duration-container"><p class="duration-current">0:00</p><p class="duration-total">0:00</p><div class="progress-bar-container"><div class="progress-track"></div><div class="progress-bar"><div class="progress-marker-container"><div class="progress-marker"></div></div></div></div></div><div class="media-controls"><div class="media-controls-container"><div class="media-rewind"></div><div class="media-play"></div><div class="media-forward"></div></div></div></div></div>');
	this.$overlay = $('<div class="mobile-overlay"><div class="overlay-container"><p>Please rotate your phone in horizontal mode</p></div></div>');
}
	...
	$(document).ready(function(){
        ...
        if($this.selectors && $this.selectors.length)
        {
            ...
            $this.playlist.each(function(){
                selector += '<option value="'+$(this).attr('id').replace('mixer-','')+'">'+$(this).attr('data-title')+'</option>';
            });
            $this.$media.find('select.title-select').html(selector);
            
            
            $('select.title-select').change(function(){
                var id = $(this).val();
                $this.playlist.removeClass('selected');
                $this.playlist.filter('#mixer-'+id).addClass('selected');
                $this.load();
...
Mixer.prototype.setDemo = function($demo) {
	...
	this.$media.find('select.title-select').val($demo.attr('id').replace('mixer-','')).niceSelect('update');
